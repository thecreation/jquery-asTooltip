...
(function(global, factory) {
  ...
  function(_jquery) {
    ...
    var DEFAULTS = {
      ...
      ajax: false,
      tpl: '<div class="{{namespace}}">' + '<div class="{{namespace}}-inner">' + '<div class="{{namespace}}-loading"></div>' + '<div class="{{namespace}}-content"></div>' + '</div>' + '</div>',
    ...
    var computePlacementOffset = function computePlacementOffset(element, $tip, position, isMove) {
      // grab measurements
      var elOffset = void 0;
    ...
    var getViewportCollisions = function getViewportCollisions(el, $tip, $container) {
      ...
      var offset = $container[0].tagName === 'BODY' ? eOffset : {
      ...
      var cHeight = $container[0].tagName === 'BODY' ? $win.innerHeight() : $container.outerHeight();
      var collisions = [];
    ...
    var asTooltip = function() {
      function asTooltip(element, options) {
        ...
        targetData = this.parseTargetData((0, _jquery2.default)(newTarget).data());
        opts = this.options = _jquery2.default.extend(true, {}, DEFAULTS, options, targetData);

        opts.position.container = !opts.position.container ? body : (0, _jquery2.default)(opts.position.container);
      ...
      _createClass(asTooltip, [{
        ...
        value: function init() {
          ...
          // add namepace
          this.$tip = (0, _jquery2.default)(opts.tpl.replace(/{{namespace}}/g, this.namespace));

          this.$loading = (0, _jquery2.default)('.' + this.namespace + '-loading', this.$tip);
          this.$content = (0, _jquery2.default)('.' + this.namespace + '-content', this.$tip);
        ...
        value: function _bind(targets, events, method, suffix) {
          ...
          (0, _jquery2.default)(targets).on(name, _jquery2.default.proxy(method, this));
        ...
        value: function _unbind(targets, events, suffix) {
          if (targets) {
            (0, _jquery2.default)(targets).unbind(suffix ? events : events + '.' + suffix);
          }
        ...
        value: function showMethod(obj) {
          var self = obj instanceof this.constructor ? obj : (0, _jquery2.default)(obj.currentTarget).data(NAMESPACE$1);
          var opts = this.options;
          ...
          if (opts.position.target === 'mouse') {
            ...
            this.isFirst = true;
            (0, _jquery2.default)(document).on('mousemove.' + NAMESPACE$1, _jquery2.default.proxy(this.move, self));
            this.moveFlag = true;
          }
          ...
          if (opts.hide.event === 'click') {
            ...
            if (opts.hide.container) {
              this._bind(opts.hide.container, opts.hide.event,
        ...
        value: function setPosition(e) {
          ...
          if (opts.position.auto) {
            ...
            if (opts.position.target !== 'mouse') {
              (function() {
                var collisions = getViewportCollisions(target, _this2.$tip, $container);
                var posArr = ['top', 'right', 'bottom', 'left'];
                _jquery2.default.each(collisions,

                  function(i, v) {
                    posArr = _jquery2.default.map(posArr,
          ...
          this.$tip.addClass(this.namespace + '-element-' + position[0]).addClass(this.namespace + '-arrow-' + position[1]);
      ...
      return this.each(
        ...
        function() {
          if (!(0, _jquery2.default)(this).data(NAMESPACE)) {
            (0, _jquery2.default)(this).data(NAMESPACE, new asTooltip(this, options));
          }
        }
      );
    };
